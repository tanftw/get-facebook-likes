...
class GFL_Settings
{
	...
	{
		add_options_page( 
			__( 'Get Facebook Likes', 'get-facebook-likes' ), 
			__( 'Get Facebook Likes', 'get-facebook-likes' ), 
			'manage_options', 
			'get-facebook-likes', 
	...
	public function admin_page()
	{
		...
		<div class="wrap">
			<h2><?php _e( 'Get Facebook Likes', 'get-facebook-likes' ); ?></h2>
			
			<?php 
			// Display success message when settings saved
			if ( isset( $_GET['success'] ) ) : ?>
			<div id="message" class="updated notice is-dismissible">
				<p><?php _e( 'Settings <strong>saved</strong>.', 'get-facebook-likes' ); ?></p>
				...
				<div id="post-body" class="metabox-holder columns-2">
					...
					<div id="postbox-container-2" class="postbox-container">
						...
						<div class="meta-box-sortables">
							...
							<?php do_action( 'gfl_before_general_settings' ); ?>

							<div class="postbox">
			                	<div class="handlediv" title="Click to toggle"> <br></div>
			                  	<h3 class="hndle ui-sortable-handle"><?php _e( 'General Settings', 'get-facebook-likes' ); ?></h3>
			                  	<div class="inside">
			                    	<table class="form-table">
			                    		<tr valign="top">
			                    			<th><?php _e( 'Mode', 'get-facebook-likes' ); ?></th>
			                    			<td>
			                    				<div>

				                    				<label>
														<input type="radio" name="mode" value="basic" <?php if ( gfl_setting( 'mode' ) == 'basic' ) echo 'checked'; ?>> <?php _e( 'Basic', 'get-facebook-likes' ); ?>
				                    				</label>
				                    				<p class="description">
				                    					<?php 
				                    					...
				                    					<strong>Cons:</strong> Less accurate, a little bit slower page load', 'get-facebook-likes' );
				                    					?>
				                    				</p>
			                    				</div>
												...
												<section>
				                    				<label>
														<input type="radio" name="mode" value="advanced" <?php if ( gfl_setting( 'mode' ) == 'advanced' ) echo 'checked'; ?>> <?php _e( 'Advanced', 'get-facebook-likes' ); ?> <code><?php _e( 'Recommended', 'get-facebook-likes' ); ?></code>
				                    				</label>
			                    					<p class="description">
			                    						<?php
												...
												<section id="auto_add_section">
													...
													<label for="auto_add">
														...
														<?php _e( 'Auto add JS SDK to <code>wp_head</code>', 'get-facebook-likes' ); ?>
													</label>
													<p class="description">
														<?php 
														...
														Uncheck this checkbox in case you already have FB JS SDK installed or you want to setup by yourself.", 'get-facebook-likes' );
														?>
													</p>
												...
												<section id="app_id_section">
													<label for="app_id"><code><?php _e( 'App ID', 'get-facebook-likes' ); ?></code> <?php _e( 'Optional', 'get-facebook-likes' ); ?></label><br>
													<input type="text" id="app_id" name="app_id" value="<?php echo gfl_setting( 'app_id' ); ?>"> 
													<p class="description"><?php _e( 'Your Facebook App ID', 'get-facebook-likes' ); ?> <?php _e( 'Recommended', 'get-facebook-likes' ); ?></p>
												</section>
												
												<section id="sdk_locale_section">
													<label for="sdk_locale"><code><?php _e( 'SDK Locale', 'get-facebook-likes' ); ?></code> <?php _e( 'Optional', 'get-facebook-likes' ); ?></label><br>
													<input type="text" id="sdk_locale" name="sdk_locale" value="<?php echo gfl_setting('sdk_locale' ); ?>">
													<p class="description">
														<?php _e( 'In case you\'re using Facebook SDK in your language', 'get-facebook-likes' ); ?>
													</p>
												</section>

			                    				<section id="setup-guide">
													<h3><?php _e( 'Setup Guide', 'get-facebook-likes' ); ?></h3>
													<p class="description"><?php _e( "If you've already checked <code>Auto add JS SDK to wp_head</code>. Please ignore this guide.", 'get-facebook-likes' ); ?></p>
													<hr>
													<h4><?php _e ( 'Step 1', 'get-facebook-likes' ); ?></h4>
													<p>
														<?php _e ( 'If you\'ve already setup Facebook JS SDK, ignore this step. Otherwise, follow <a href="https://developers.facebook.com/docs/javascript/quickstart/v2.5">FB Quick Start Guide</a>', 'get-facebook-likes' ); ?>
													</p>
													<hr>
													<h4><?php _e( 'Step 2', 'get-facebook-likes' ); ?></h4>
													<p>
														<?php _e( 'Add <code>GFL_Main.init();</code> after <code>FB.init();</code> in <code>window.fbAsyncInit</code> method, like so', 'get-facebook-likes' ); ?>
	<pre>
	window.fbAsyncInit = function() {
	    ...
	    // <?php _e( 'Add this line', 'get-facebook-likes' ); ?>
	    
	    GFL_Main.init();
	};
  </pre>
													<?php _e( "That's all", 'get-facebook-likes' ); ?>
													</p>
			                    				</section>
			                    			</td>
			                    		</tr>
			              	...
			              	<?php do_action( 'gfl_after_general_settings' ); ?>
